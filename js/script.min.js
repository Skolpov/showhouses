...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _base_checkWebp_init_check_webp_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./base/checkWebp/init-check-webp.js */ \"./src/js/base/checkWebp/init-check-webp.js\");\n/* harmony import */ var _base_validate_init_validate_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./base/validate/init-validate.js */ \"./src/js/base/validate/init-validate.js\");\n/* harmony import */ var _components_fancybox_init_fancybox_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/fancybox/init-fancybox.js */ \"./src/js/components/fancybox/init-fancybox.js\");\n/* harmony import */ var _components_swipper_sliders_init_swipper_sliders_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/swipper-sliders/init-swipper-sliders.js */ \"./src/js/components/swipper-sliders/init-swipper-sliders.js\");\n/* harmony import */ var _components_navoffcanvas_init_navoffcanvas_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/navoffcanvas/init-navoffcanvas.js */ \"./src/js/components/navoffcanvas/init-navoffcanvas.js\");\n/* harmony import */ var _base_headerScroll_init_header_scroll_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./base/headerScroll/init-header-scroll.js */ \"./src/js/base/headerScroll/init-header-scroll.js\");\n/* harmony import */ var _base_smScroll_init_smooth_scroll_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./base/smScroll/init-smooth-scroll.js */ \"./src/js/base/smScroll/init-smooth-scroll.js\");\n/* harmony import */ var _components_show_more_init_show_more_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/show-more/init-show-more.js */ \"./src/js/components/show-more/init-show-more.js\");\n/* harmony import */ var _base_anim_init_anim_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./base/anim/init-anim.js */ \"./src/js/base/anim/init-anim.js\");\n/* harmony import */ var _lib_ya_map_init_yamap_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./lib/ya-map/init-yamap.js */ \"./src/js/lib/ya-map/init-yamap.js\");\n/* ↓ Проверка поддержки Webp для подгрузки этого формата в CSS, крепится к body */\n\n/* ↑ ---- */\n\n/* ↓ Валидация (InputMask, JustValidate) */\n\n/* ↑ ---- */\n\n/* ↓ Fancybox как для галерей, так и для модальных окон */\n\n/* ↑ ---- */\n\n// /* ↓ Слайдер Swiper */\n\n// /* ↑ ---- */\n\n/* ↓ Адаптивное меню справа при клике на кнопку */\n\n/* ↑ ---- */\n\n/* ↓ Фикс шапки при скроле */\n\n/* ↑ ---- */\n\n/* ↓ Якоря */\n\n/* ↑ ---- */\n\n/* ↓ Показать еще */\n\n/* ↑ ---- */\n\n/* ↓ Анимации */\n\n/* ↑ ---- */\n\n/* ↓ Карта */\n\n/* ↑ ---- */\n\n//# sourceURL=webpack://gulp-project/./src/js/app.js?");

/***/ }),

/***/ "./src/js/base/anim/init-anim.js":
/*!***************************************!*\
  !*** ./src/js/base/anim/init-anim.js ***!
  \***************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _src_check_webp_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./src-check-webp.js */ \"./src/js/base/checkWebp/src-check-webp.js\");\n// Проверка поддержки Webp, чтобы подключать webp вместо jpg\n\n(0,_src_check_webp_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])();\n\n//# sourceURL=webpack://gulp-project/./src/js/base/checkWebp/init-check-webp.js?");

/***/ }),

/***/ "./src/js/base/checkWebp/src-check-webp.js":
/*!*************************************************!*\
  !*** ./src/js/base/checkWebp/src-check-webp.js ***!
  \*************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* export default binding */ __WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* Проверка поддержки webp, добавление класса webp или no-webp для HTML */\n/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {\n  // Проверка поддержки\n  function testWebP(callback) {\n    var webP = new Image();\n    webP.onload = webP.onerror = function () {\n      callback(webP.height == 2);\n    };\n    webP.src = \"data:image/webp;base64,UklGRjoAAABXRUJQVlA4IC4AAACyAgCdASoCAAIALmk0mk0iIiIiIgBoSygABc6WWgAA/veff/0PP8bA//LwYAAA\";\n  }\n  testWebP(function (support) {\n    if (support == true) {\n      document.querySelector('body').classList.add('webp');\n    } else {\n      document.querySelector('body').classList.add('no-webp');\n    }\n  });\n}\n\n//# sourceURL=webpack://gulp-project/./src/js/base/checkWebp/src-check-webp.js?");

/***/ }),

/***/ "./src/js/base/headerScroll/init-header-scroll.js":
/*!********************************************************!*\
  !*** ./src/js/base/headerScroll/init-header-scroll.js ***!
  \********************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _src_header_scroll_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./src-header-scroll.js */ \"./src/js/base/headerScroll/src-header-scroll.js\");\n// // Шапка-липучка при скроле\n// import headerScroll from './src-header-scroll.js';\n// headerScroll.work()\n\n// Шапка-липучка при скроле\n\n(0,_src_header_scroll_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])();\n\n//# sourceURL=webpack://gulp-project/./src/js/base/headerScroll/init-header-scroll.js?");

/***/ }),

/***/ "./src/js/base/headerScroll/src-header-scroll.js":
/*!*******************************************************!*\
  !*** ./src/js/base/headerScroll/src-header-scroll.js ***!
  \*******************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _src_smooth_scroll_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./src-smooth-scroll.js */ \"./src/js/base/smScroll/src-smooth-scroll.js\");\n\nconst smScroll = new SmoothScroll('[data-scroll]', {\n  speed: 256\n});\n\n//# sourceURL=webpack://gulp-project/./src/js/base/smScroll/init-smooth-scroll.js?");

/***/ }),

/***/ "./src/js/base/smScroll/src-smooth-scroll.js":
/*!***************************************************!*\
  !*** ./src/js/base/smScroll/src-smooth-scroll.js ***!
  \***************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _src_validate_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./src-validate.js */ \"./src/js/base/validate/src-validate.js\");\n/* harmony import */ var _other_fnc_after_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./other/fnc-after.js */ \"./src/js/base/validate/other/fnc-after.js\");\n/* harmony import */ var _other_validate_rules_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./other/validate-rules.js */ \"./src/js/base/validate/other/validate-rules.js\");\n\n\n\nconst afterForm = () => {\n  (0,_other_fnc_after_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\n};\n(0,_src_validate_js__WEBPACK_IMPORTED_MODULE_0__.validateForms)('#form-modal', _other_validate_rules_js__WEBPACK_IMPORTED_MODULE_2__.rlMdlCal, afterForm);\n(0,_src_validate_js__WEBPACK_IMPORTED_MODULE_0__.validateForms)('#form-aboutus', _other_validate_rules_js__WEBPACK_IMPORTED_MODULE_2__.rlAbtUs, afterForm);\n(0,_src_validate_js__WEBPACK_IMPORTED_MODULE_0__.validateForms)('#form-final', _other_validate_rules_js__WEBPACK_IMPORTED_MODULE_2__.rlFnl, afterForm);\n\n//# sourceURL=webpack://gulp-project/./src/js/base/validate/init-validate.js?");

/***/ }),

/***/ "./src/js/base/validate/lib/lib-inputmask.js":
/*!***************************************************!*\
  !*** ./src/js/base/validate/lib/lib-inputmask.js ***!
  \***************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   validateForms: () => (/* binding */ validateForms)\n/* harmony export */ });\n/* harmony import */ var _lib_lib_inputmask_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./lib/lib-inputmask.js */ \"./src/js/base/validate/lib/lib-inputmask.js\");\n/* harmony import */ var _lib_lib_validate_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./lib/lib-validate.js */ \"./src/js/base/validate/lib/lib-validate.js\");\n\n\nconst validateForms = (selector, rules, afterSend) => {\n  const form = document?.querySelector(selector);\n  const telSelector = form?.querySelector('input[type=\"tel\"]');\n  if (form) {\n    if (!rules) {\n      console.error('Вы не передали правила валидации!');\n      return false;\n    }\n    if (telSelector) {\n      const inputMask = new Inputmask('+7 (999) 999-99-99');\n      inputMask.mask(telSelector);\n      for (let item of rules) {\n        if (item.tel) {\n          item.rules.push({\n            rule: 'function',\n            validator: function () {\n              const phone = telSelector.inputmask.unmaskedvalue();\n              return phone.length === 10;\n            },\n            errorMessage: item.telError\n          });\n        }\n      }\n    }\n    const validation = new JustValidate(selector);\n    for (let item of rules) {\n      validation.addField(item.ruleSelector, item.rules);\n    }\n    validation.onSuccess(ev => {\n      let formData = new FormData(ev.target);\n      let xhr = new XMLHttpRequest();\n      xhr.onreadystatechange = function () {\n        if (xhr.readyState === 4) {\n          if (xhr.status === 200) {\n            if (afterSend) {\n              afterSend();\n            }\n            console.log('Отправлено');\n          }\n        }\n      };\n      xhr.open('POST', 'mail.php', true);\n      xhr.send(formData);\n      ev.target.reset();\n    });\n  }\n};\n\n//# sourceURL=webpack://gulp-project/./src/js/base/validate/src-validate.js?");

/***/ }),

/***/ "./src/js/components/fancybox/init-fancybox.js":
/*!*****************************************************!*\
  !*** ./src/js/components/fancybox/init-fancybox.js ***!
  \*****************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _fancyapps_ui__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @fancyapps/ui */ \"./node_modules/@fancyapps/ui/dist/index.esm.js\");\n\n_fancyapps_ui__WEBPACK_IMPORTED_MODULE_0__.Fancybox.bind('[data-fancybox]', {\n  closeButton: false,\n  dragToClose: false\n});\n_fancyapps_ui__WEBPACK_IMPORTED_MODULE_0__.Fancybox.bind('[data-fancybox=\"gallery\"]', {\n  wheel: false,\n  click: 'zoomToFit',\n  dragToClose: false,\n  Toolbar: {\n    display: {\n      left: [],\n      middle: [\"prev\", \"infobar\", \"next\"],\n      right: [\"close\"]\n    }\n  },\n  Thumbs: {\n    showOnStart: false\n  }\n});\n\n//# sourceURL=webpack://gulp-project/./src/js/components/fancybox/init-fancybox.js?");

/***/ }),

/***/ "./src/js/components/navoffcanvas/init-navoffcanvas.js":
/*!*************************************************************!*\
  !*** ./src/js/components/navoffcanvas/init-navoffcanvas.js ***!
  \*************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _src_navoffcanvas_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./src-navoffcanvas.js */ \"./src/js/components/navoffcanvas/src-navoffcanvas.js\");\n\n(0,_src_navoffcanvas_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])();\n\n//# sourceURL=webpack://gulp-project/./src/js/components/navoffcanvas/init-navoffcanvas.js?");

/***/ }),

/***/ "./src/js/components/navoffcanvas/src-navoffcanvas.js":
/*!************************************************************!*\
  !*** ./src/js/components/navoffcanvas/src-navoffcanvas.js ***!
  \************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _src_show_more_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./src-show-more.js */ \"./src/js/components/show-more/src-show-more.js\");\n/* ↓ Показать еще */\n\n_src_show_more_js__WEBPACK_IMPORTED_MODULE_0__.excerptWidget.showMore('.j-shw-mre-btn', '.j-shw-mre-con');\n\n//# sourceURL=webpack://gulp-project/./src/js/components/show-more/init-show-more.js?");

/***/ }),

/***/ "./src/js/components/show-more/src-show-more.js":
/*!******************************************************!*\
  !*** ./src/js/components/show-more/src-show-more.js ***!
  \******************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! swiper */ \"./node_modules/swiper/swiper.mjs\");\n/* harmony import */ var swiper_modules__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! swiper/modules */ \"./node_modules/swiper/modules/index.mjs\");\n\n\nconst clientsSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('.clients-swiper', {\n  direction: 'horizontal',\n  // loop: true,\n  speed: 500,\n  slidesPerView: 2,\n  spaceBetween: 8,\n  // С какого слайда начинаем\n  // initialSlide: 1,\n  // Центровка\n  // centeredSlides: true,\n  // Можно перетаскивать как ленту\n  // freeMode: true,\n\n  modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination],\n  breakpoints: {\n    768: {\n      slidesPerView: 3\n    },\n    992: {\n      slidesPerView: 4\n    },\n    1200: {\n      slidesPerView: 4\n    },\n    1366: {\n      slidesPerView: 6\n    }\n  },\n  pagination: {\n    el: '.swiper-pagination',\n    clickable: true\n  }\n});\nconst teamSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('.team-swiper', {\n  direction: 'horizontal',\n  // loop: true,\n  speed: 500,\n  slidesPerView: 1,\n  spaceBetween: 8,\n  // С какого слайда начинаем\n  // initialSlide: 1,\n  // Центровка\n  // centeredSlides: true,\n  // Можно перетаскивать как ленту\n  // freeMode: true,\n\n  modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination],\n  breakpoints: {\n    // 576: {\n    // },\n    768: {\n      slidesPerView: 2\n    },\n    992: {\n      slidesPerView: 3\n    },\n    1200: {\n      slidesPerView: 3\n    }\n  },\n  pagination: {\n    el: '.swiper-pagination',\n    clickable: true\n  },\n  navigation: {\n    nextEl: '.tem-next',\n    prevEl: '.tem-prev'\n  }\n\n  // scrollbar: {\n  // \tel: '.swiper-scrollbar',\n  // },\n});\nconst reviewSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('.review-swiper', {\n  direction: 'horizontal',\n  // loop: true,\n  speed: 500,\n  slidesPerView: 1,\n  spaceBetween: 8,\n  // С какого слайда начинаем\n  // initialSlide: 1,\n  // Центровка\n  // centeredSlides: true,\n  // Можно перетаскивать как ленту\n  // freeMode: true,\n\n  modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination],\n  breakpoints: {\n    // 576: {\n    // },\n    768: {\n      slidesPerView: 2\n    },\n    992: {\n      slidesPerView: 2\n    },\n    1200: {\n      slidesPerView: 2,\n      spaceBetween: 32\n    }\n  },\n  pagination: {\n    el: '.swiper-pagination',\n    clickable: true\n  },\n  navigation: {\n    nextEl: '.rvw-next',\n    prevEl: '.rvw-prev'\n  }\n\n  // scrollbar: {\n  // \tel: '.swiper-scrollbar',\n  // },\n});\nconst serviceSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('.service-swiper', {\n  direction: 'horizontal',\n  // loop: true,\n  speed: 500,\n  slidesPerView: 2,\n  spaceBetween: 8,\n  // С какого слайда начинаем\n  // initialSlide: 1,\n  // Центровка\n  // centeredSlides: true,\n  // Можно перетаскивать как ленту\n  // freeMode: true,\n\n  modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination],\n  breakpoints: {\n    // 576: {\n    // },\n    768: {\n      slidesPerView: 2\n    },\n    992: {\n      slidesPerView: 3\n    },\n    1200: {\n      slidesPerView: 4\n    }\n  },\n  pagination: {\n    el: '.swiper-pagination',\n    clickable: true\n  }\n\n  // scrollbar: {\n  // \tel: '.swiper-scrollbar',\n  // },\n});\n\n//# sourceURL=webpack://gulp-project/./src/js/components/swipper-sliders/init-swipper-sliders.js?");

/***/ }),

/***/ "./src/js/lib/ya-map/init-yamap.js":
/*!*****************************************!*\
  !*** ./src/js/lib/ya-map/init-yamap.js ***!
  \*****************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nconst mapsChecker = document.querySelector('.map-chk');\nif (mapsChecker) {\n  function init() {\n    let map = new ymaps.Map('map-final', {\n      center: [55.75154859791044, 37.61811382655863],\n      zoom: 14\n    });\n    map.controls.remove('searchControl');\n    map.controls.remove('geolocationControl');\n    map.controls.remove('trafficControl');\n    // map.controls.remove('typeSelector');\n    map.controls.remove('fullscreenControl');\n    // map.controls.remove('zoomControl');\n    // map.controls.remove('rulerControl');\n    // map.controls.remove('scrollZoom');\n  }\n  ymaps.ready(init);\n}\n\n//# sourceURL=webpack://gulp-project/./src/js/lib/ya-map/init-yamap.js?");
